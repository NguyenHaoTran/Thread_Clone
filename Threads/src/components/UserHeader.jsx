...
import { Box, Flex, Avatar, Text, Link, 
            Menu, MenuButton, MenuItem,
            MenuList, Portal, useToast
...
const UserHeader = () => {
  ...
  <VStack gap={4} alignItems={'start'}>
    ...
    <Text>something you want to write in here.</Text>
