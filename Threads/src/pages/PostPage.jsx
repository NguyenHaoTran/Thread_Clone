    ...
    <>
      <Flex>
        <Flex w={"full"} alignItems={"center"} gap={3}>
            ...
            <Flex>
              <Text fontSize={"sm"} fontWeight={"bold"}>Nghao.t</Text>
      ...
      />
      <Comment comment="ahh ok" 
                createdAt="3d" 
                likes={34} 
                username="aydo" 
                userAvatar="https://bit.ly/code-beast"
      />
      <Comment comment="like shit" 
                createdAt="recently" 
                likes={2} 
                username="alone" 
                userAvatar="https://bit.ly/sage-adebayo"
